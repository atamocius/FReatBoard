...
local list = {
  ...
  -- -- Using Shreddage 3 Hydra (8-strings), but only utilizing the 8-2
  -- {
  --   name = '[GTR 7, 21] Drop G (Hydra, 8765432)',
  --   pitches = {
  --     62, -- D4
  --     57, -- A3
  --     53, -- F3
  ...
  -- -- Using Shreddage 3 Hydra (8-strings), but only utilizing the 8-2
  -- {
  --   name = '[GTR 7, 23] Drop F (Hydra, 8765432)',
  --   pitches = {
  --     60, -- C4
  --     55, -- G3
  --     51, -- D#|Eb3
  ...
  -- -- Drop D
  -- -- Using Shreddage 3 Hydra (8-strings)
  -- {
